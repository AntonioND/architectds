...
#include "fonts/font_0_256_png.h"
#include "fonts/font2_0_16_png.h"

#include "fonts/font_fnt.h"
#include "fonts/font2_fnt.h"
...
int main(int argc, char **argv)
{
    ...
    dsf_handle handle;
    dsf_error rc = DSF_LoadFontMemory(&handle, font_fnt, font_fnt_size);
    if (rc != DSF_NO_ERROR)
    {
    ...
    dsf_handle handle2;
    rc = DSF_LoadFontMemory(&handle2, font2_fnt, font2_fnt_size);
    if (rc != DSF_NO_ERROR)
    {
