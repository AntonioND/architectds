...
#include "grit/a5pal8_png.h"
#include "grit/a3pal32_png.h"
...
int main(void)
{
    ...
    NE_MaterialTexLoad(Material1, NE_A3PAL32, 256, 192, NE_TEXGEN_TEXCOORD,
                       (u8 *)a3pal32_pngBitmap);

    // Load complete texture
    NE_MaterialTexLoad(Material2, NE_A5PAL8, 256, 256, NE_TEXGEN_TEXCOORD,
                       (u8 *)a5pal8_pngBitmap);

    NE_PaletteLoad(Palette1, (u16 *)a3pal32_pngPal, 32, NE_A3PAL32);
    NE_PaletteLoad(Palette2, (u16 *)a5pal8_pngPal, 32, NE_A5PAL8);
